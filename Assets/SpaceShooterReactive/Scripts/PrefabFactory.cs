...
// Two parameters
public class GameObjectFactory<P1, P2, T> : IValidatable
    where T : Component
{
    [Inject]
    protected readonly DiContainer _container;
...
// Three parameters
public class GameObjectFactory<P1, P2, P3, T> : IValidatable
    where T : Component
{
    [Inject]
    protected readonly DiContainer _container;
...
// Four parameters
public class GameObjectFactory<P1, P2, P3, P4, T> : IValidatable
    where T : Component
{
    [Inject]
    protected readonly DiContainer _container;
